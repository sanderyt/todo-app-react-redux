...
const TaskItem = props => {
  ...
  return (
    <div
      className={props.archived ? "task-item--done" : "task-item"}
      onClick={props.click}
    >
      <div className="task-item__check">
        <input
          ...
          id="horns"
          name="horns"
          defaultChecked={props.archived}
          onChange={props.complete}
        />
      </div>
      <div className="task-item__name">{props.task}</div>
      <div className="task-item__details">
        <p>{props.project}</p>
        <p>{props.date}</p>
        <p>
          {props.priority}{" "}
          <FontAwesomeIcon icon={faCircle} style={priorityColor()} />
        </p>
        ...
        <div>
          ...
          {deleteTask && (
            <ConfirmBox
              keep={() => setDeleteTask(false)}
              delete={() => props.delete(props.taskId)}
            >
              <p>Are you sure?</p>
            </ConfirmBox>
          )}
